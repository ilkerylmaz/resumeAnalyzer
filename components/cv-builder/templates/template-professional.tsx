...
// Template A - Professional (Single Column, current default)
        ...
        <div className="max-w-3xl mx-auto bg-white shadow-2xl overflow-hidden min-h-[1122px]">
            ...
            <div className="p-8">
                ...
                {personalInfo.summary && (
                    <div className="mb-6">
                        <h2 className="text-lg font-bold text-gray-900 mb-2 border-b-2 border-primary pb-1">
                ...
                {experiences.length > 0 && (
                    <div className="mb-6">
                        <h2 className="text-lg font-bold text-gray-900 mb-3 border-b-2 border-primary pb-1">
